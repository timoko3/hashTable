...
values = [4, 3, 4, 7, 0, 3, 5, 1, 1, 5, 1, 3, 4, 1, 0, 0, 0, 2, 1, 4, 2, 5, 4, 1, 3, 2, 6, 2, 1, 2, 2, 4, 1, 5, 1, 4, 1, 0, 2, 2, 1, 2, 5, 5, 5, 3, 1, 2, 9, 3, 1, 1, 5, 2, 28, 1, 4, 3, 0, 3, 11, 0, 1, 2, 5, 1, 7, 0, 1, 2, 12, 2, 0, 1, 11, 0, 2, 1, 1, 2, 6, 7, 8, 0, 10, 1, 7, 1, 0, 10, 3, 2, 2, 4, 0, 1, 2, 1, 0, 2]
plt.bar(cellNum, values)
plt.title("Загрузка хэш-таблицы")
plt.savefig('exDiag.png')
